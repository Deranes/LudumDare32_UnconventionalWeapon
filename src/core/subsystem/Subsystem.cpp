...
Subsystem::Subsystem( const std::string& name, const std::string& userFriendlyName )
...
const std::string& Subsystem::GetUserFriendlyName( ) const
{
...
void Subsystem::Update( const float deltaTime )
{
}
